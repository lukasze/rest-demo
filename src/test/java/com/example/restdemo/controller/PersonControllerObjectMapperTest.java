...
/*
    We use @SpringBootTest instead of @WebMvcTest to use PersonRepository bean
    When we use @SpringBootTest, to use @Autowired on MockMvc, we need to add @AutoConfigureMockMvc
 */
@SpringBootTest
